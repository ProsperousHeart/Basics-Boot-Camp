# ABOUTME: MkDocs hook to copy IMGs folder to JupyterLite files directory after build
# ABOUTME: This ensures notebook image references (../../IMGs/) work in the JupyterLite environment
...
def on_post_build(config, **kwargs):
    ...
    if source.exists():
        ...
        print(f"✓ Copied {len(list(source.glob('**/*')))} files from {source} to {dest}")
    else:
