...
1. **[Iterators & Generators](Python_Basics_13_-_Iterators_And_Generators.md)** - Efficient iteration patterns
2. **[Functions](Python_Basics_14_-_Functions.md)** - Creating reusable code blocks
3. **[Scope of Variables](Python_Basics_15_-_Scope_Of_Variables.md)** - Understanding variable visibility
4. **[Modules](Python_Basics_16_-_Modules.md)** - Organizing and importing code
...
### Modules
Modules help you organize code into logical units:
...
1. **Practice function design** - Think about what each function should do
2. **Use descriptive names** - Function names should explain their purpose
3. **Keep functions focused** - Each function should do one thing well
4. **Comment your code** - Explain complex logic
5. **Test as you go** - Try your functions with different inputs

## Next Steps

After completing Week 2 and the Rock, Paper, Scissors game, move on to [Week 3](../Week_3/index.md) to learn about file I/O and error handling!
