...
Be sure to follow the [GitHub repo](https://github.com/ProsperousHeart/Basics-Boot-Camp) to be updated when doors open next.

## Learn More

- 📖 [**Course Structure**](home/course-structure.md) - Detailed week-by-week breakdown
- ⏱️ [**Time Expectations**](home/time-expectations.md) - How long does it take?
- 🎓 [**Enrollment Options**](home/enrollment.md) - Get direct feedback and support
- 💡 [**Training Philosophy**](home/training-philosophy.md) - Our approach to teaching
- 🔨 [**Why Homework?**](home/implementation.md) - The importance of practice
- 🔗 [**Additional Resources**](home/missing-resources.md) - Helpful links and cheatsheets
...
Visit the [Interactive Lab](interactive-jupyter.md) to run Python code directly in your browser - no installation needed!
...
1. 👉 [**Getting Started**](getting-started/index.md) - Set up your environment
2. 📖 [**Week 1**](BC_Weeks/Week_1/index.md) - Begin learning Python basics
3. 🎮 [**Interactive Lab**](interactive-jupyter.md) - Practice with JupyterLite
4. 💡 [**Helpful Hints**](tutorials/Helpful_Hints.md) - Tips and tricks

---

**Ready to start learning?** Head to [Getting Started](getting-started/index.md) to begin your Python journey!
