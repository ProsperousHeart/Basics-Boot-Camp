import os
import unittest
from W3H1_IO import read_n_match, print_to_file
...
But my love returns no more."""
    ...
    def test_read_n_match_success(self):
        ...
        self.assertIsInstance(TestIO.match_list, list, "Function did not return a list!")
        # self.assertEqual(len(rtnd_list), TestIO.match_num, "Incorrect number of lines found")
        self.assertEqual(len(TestIO.match_list), TestIO.match_num, "Incorrect number of lines found")
